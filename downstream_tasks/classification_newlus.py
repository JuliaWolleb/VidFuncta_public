...
class NFDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        v = data['v']
        df = pd.read_csv('/gpfs/gibbs/project/hartley/jw3234/COVID-BLUES/ultrasound/severity_path.csv')
...
def train(model, train_loader, criterion, optimizer, device, num_classes, clip):
    ...
    for data, v, labels in train_loader:
        ...
        indices = torch.arange(start, 100, step=3)

        cut = torch.randint(1,59,(1,)) 
...
class Args:
    def __init__(self):
        self.data_dir = "./reconstructions/lus_spatial_4464/nfset" 
